...
public class CordovaWebViewImpl implements CordovaWebView {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:42:0x00ef A[ExcHandler: URISyntaxException (r9v1 'e' java.net.URISyntaxException A[CUSTOM_DECLARE]), Splitter:B:15:0x006d] */
    ...
    public void showWebPage(java.lang.String r8, boolean r9, boolean r10, java.util.Map<java.lang.String, java.lang.Object> r11) {
        ...
        L_0x006c:
            r1 = 0
            boolean r4 = r8.startsWith(r0)     // Catch:{ URISyntaxException -> 0x00ef, ActivityNotFoundException -> 0x00bf }
            if (r4 == 0) goto L_0x0078
            android.content.Intent r1 = android.content.Intent.parseUri(r8, r3)     // Catch:{ URISyntaxException -> 0x00ef, ActivityNotFoundException -> 0x00bf }
            goto L_0x00a2
        L_0x0078:
            android.content.Intent r3 = new android.content.Intent     // Catch:{ URISyntaxException -> 0x00ef, ActivityNotFoundException -> 0x00bf }
            java.lang.String r4 = "android.intent.action.VIEW"
            r3.<init>(r4)     // Catch:{ URISyntaxException -> 0x00ef, ActivityNotFoundException -> 0x00bf }
            java.lang.String r1 = "android.intent.category.BROWSABLE"
            r3.addCategory(r1)     // Catch:{ URISyntaxException -> 0x00ef, ActivityNotFoundException -> 0x00ba }
            android.net.Uri r1 = android.net.Uri.parse(r8)     // Catch:{ URISyntaxException -> 0x00ef, ActivityNotFoundException -> 0x00ba }
            java.lang.String r4 = "file"
            java.lang.String r5 = r1.getScheme()     // Catch:{ URISyntaxException -> 0x00ef, ActivityNotFoundException -> 0x00ba }
            boolean r4 = r4.equals(r5)     // Catch:{ URISyntaxException -> 0x00ef, ActivityNotFoundException -> 0x00ba }
            if (r4 == 0) goto L_0x009e
            org.apache.cordova.CordovaResourceApi r4 = r7.resourceApi     // Catch:{ URISyntaxException -> 0x00ef, ActivityNotFoundException -> 0x00ba }
            java.lang.String r4 = r4.getMimeType(r1)     // Catch:{ URISyntaxException -> 0x00ef, ActivityNotFoundException -> 0x00ba }
            r3.setDataAndType(r1, r4)     // Catch:{ URISyntaxException -> 0x00ef, ActivityNotFoundException -> 0x00ba }
            goto L_0x00a1
        L_0x009e:
            r3.setData(r1)     // Catch:{ URISyntaxException -> 0x00ef, ActivityNotFoundException -> 0x00ba }
        L_0x00a1:
            r1 = r3
        L_0x00a2:
            org.apache.cordova.CordovaInterface r3 = r7.cordova     // Catch:{ URISyntaxException -> 0x00ef, ActivityNotFoundException -> 0x00bf }
            androidx.appcompat.app.AppCompatActivity r3 = r3.getActivity()     // Catch:{ URISyntaxException -> 0x00ef, ActivityNotFoundException -> 0x00bf }
            if (r3 == 0) goto L_0x00b4
            org.apache.cordova.CordovaInterface r3 = r7.cordova     // Catch:{ URISyntaxException -> 0x00ef, ActivityNotFoundException -> 0x00bf }
            androidx.appcompat.app.AppCompatActivity r3 = r3.getActivity()     // Catch:{ URISyntaxException -> 0x00ef, ActivityNotFoundException -> 0x00bf }
            r3.startActivity(r1)     // Catch:{ URISyntaxException -> 0x00ef, ActivityNotFoundException -> 0x00bf }
            goto L_0x0106
        L_0x00b4:
            java.lang.String r3 = "Cordova activity does not exist."
            org.apache.cordova.LOG.d(r2, r3)     // Catch:{ URISyntaxException -> 0x00ef, ActivityNotFoundException -> 0x00bf }
            goto L_0x0106
        L_0x00ba:
            r1 = move-exception
            r6 = r3
