...
public class ResumeCallback extends CallbackContext {
    ...
    public void sendPluginResult(org.apache.cordova.PluginResult r6) {
        /*
            r5 = this;
            monitor-enter(r5)
            boolean r0 = r5.finished     // Catch:{ all -> 0x0086 }
            ...
            java.lang.String r2 = r5.serviceName     // Catch:{ all -> 0x0086 }
            ...
            java.lang.StringBuilder r6 = r1.append(r6)     // Catch:{ all -> 0x0086 }
            java.lang.String r6 = r6.toString()     // Catch:{ all -> 0x0086 }
            org.apache.cordova.LOG.w((java.lang.String) r0, (java.lang.String) r6)     // Catch:{ all -> 0x0086 }
            monitor-exit(r5)     // Catch:{ all -> 0x0086 }
            return
        L_0x0029:
            r0 = 1
            r5.finished = r0     // Catch:{ all -> 0x0086 }
            monitor-exit(r5)     // Catch:{ all -> 0x0086 }
            ...
            java.lang.String r3 = r5.serviceName     // Catch:{ JSONException -> 0x0058 }
            ...
            int r4 = r6.getStatus()     // Catch:{ JSONException -> 0x0058 }
