...
public class PluginManager {
        ...
        synchronized (this.entryMap) {
            for (PluginEntry next : this.entryMap.values()) {
                if (next.onload) {
                    ...
                    LOG.d(TAG, "startupPlugins: put - " + next.service);
    ...
    public java.lang.Object postMessage(java.lang.String r4, java.lang.Object r5) {
        /*
            ...
            monitor-enter(r0)
            int r1 = android.os.Build.VERSION.SDK_INT     // Catch:{ all -> 0x0054 }
            r2 = 24
            if (r1 < r2) goto L_0x002c
            java.util.Map<java.lang.String, org.apache.cordova.CordovaPlugin> r1 = r3.pluginMap     // Catch:{ all -> 0x0054 }
            org.apache.cordova.-$$Lambda$PluginManager$kKlpZRFgWP16asRDDcqrOrVxJAs r2 = new org.apache.cordova.-$$Lambda$PluginManager$kKlpZRFgWP16asRDDcqrOrVxJAs     // Catch:{ all -> 0x0054 }
            r2.<init>(r4, r5)     // Catch:{ all -> 0x0054 }
            r1.forEach(r2)     // Catch:{ all -> 0x0054 }
            goto L_0x004c
        L_0x002c:
            java.util.Map<java.lang.String, org.apache.cordova.CordovaPlugin> r1 = r3.pluginMap     // Catch:{ all -> 0x0054 }
            java.util.Collection r1 = r1.values()     // Catch:{ all -> 0x0054 }
            java.util.Iterator r1 = r1.iterator()     // Catch:{ all -> 0x0054 }
        L_0x0036:
            boolean r2 = r1.hasNext()     // Catch:{ all -> 0x0054 }
            if (r2 == 0) goto L_0x004c
            java.lang.Object r2 = r1.next()     // Catch:{ all -> 0x0054 }
            org.apache.cordova.CordovaPlugin r2 = (org.apache.cordova.CordovaPlugin) r2     // Catch:{ all -> 0x0054 }
            if (r2 == 0) goto L_0x0036
            java.lang.Object r2 = r2.onMessage(r4, r5)     // Catch:{ all -> 0x0054 }
            if (r2 == 0) goto L_0x0036
    ...
    private String getLaunchUrlPrefix() {
        ...
        return lowerCase + "://" + this.app.getPreferences().getString("hostname", DEFAULT_HOSTNAME) + '/';
    }
